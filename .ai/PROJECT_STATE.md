...
**Latest completed full roadmap target:** I7 compaction-negative retained facts is complete through I7.6, after ROADMAP §10/§11 **Provider Registry + Controlled Memory Key Ontology** completed through P10. **Current implementation target:** Phase 4 async/lifecycle/governance is selected. Use `docs/design/PHASE4_PLATFORM_PLAN.md` as the authoritative next plan: start with P4-A async foundation, then P4-B lifecycle/reflection scheduler, P4-C versions/conflicts, and P4-D governance. Do not pull in TS/MCP/IDE integration work during the Phase 4 slice.
...
- **Immediate next action:** start P4-A1 Settings, Task Contracts, and Dependencies with RED tests for `TaskEnvelope`, secret-key payload validation, and eager-safe async defaults.
