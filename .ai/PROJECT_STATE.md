...
**Selected next implementation target:** none yet. Choose deliberately from remaining roadmap candidates such as Phase 3-B dashboard, maintenance scheduler/admin governance depth, advanced retrieval/storage, or adoption-driven IDE work. Keep governance default-off, keep telemetry/network/provider integrations opt-in, and keep all integrations as thin clients over `/v1`/SDK semantics without bypassing `MemoryRuntime`.
...
- **Historical next action after R1 review:** select and plan OpenTelemetry/OpenInference exporter; superseded by completed OTel/OpenInference Segment 4 closeout. Current next target is not yet selected.
...
- **Historical next action after R1 closeout:** select and plan OpenTelemetry/OpenInference exporter; superseded by completed OTel/OpenInference Segment 4 closeout. Current next target is not yet selected.
...
- **Historical next action after post-R1 hardening:** select and plan OpenTelemetry/OpenInference exporter; superseded by completed OTel/OpenInference Segment 4 closeout. Current next target is not yet selected.
...
- **Historical next action after R1-B3:** R1-C1 release checklist, followed by R1-C2 full verification and project-memory/ROADMAP closeout; superseded by completed R1-C1/R1-C2 and completed OTel/OpenInference Segment 4 closeout. Current next target is not yet selected.
...
- **Historical next action after R1-A0/A1/A2:** R1-A3 demo flow consolidation / smoke coverage; superseded by completed R1-A3/B1/B2/B3/C1/C2 and completed OTel/OpenInference Segment 4 closeout. Current next target is not yet selected.
...
- **Historical next action after cross-INT review:** choose the next roadmap target; superseded by R1 selection, completed R1-A0/A1/A2/A3/B1/B2/B3/C1/C2, and completed OTel/OpenInference Segment 4 closeout. Current next target is not yet selected. Dedicated IDE extension remains deferred until MCP adoption feedback exists.
