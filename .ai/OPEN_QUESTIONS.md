...
- **Next roadmap after §10/§11:** RESOLVED (2026-06-14). **I7 compaction-negative retained facts** is complete through I7.6, including benchmark `case_13_compaction_retains_negative_lesson`, acceptance `variant_2_retains_negative_lesson_under_compaction`, and closeout verification. **Phase 4 platform work is selected next** via `docs/design/PHASE4_PLATFORM_PLAN.md`; external integrations (`docs/design/INTEGRATIONS_PLAN.md`) remain later, and the real Reflection/Forgetting scheduler is included in Phase 4 P4-B after the async foundation.
