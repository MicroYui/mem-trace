...
- **Next roadmap after §10/§11:** RESOLVED (2026-06-14). **I7 compaction-negative retained facts** is complete through I7.6, including benchmark `case_13_compaction_retains_negative_lesson`, acceptance `variant_2_retains_negative_lesson_under_compaction`, and closeout verification. Next roadmap selection is open among real Reflection/Forgetting scheduler (replace deterministic `variant_3` reflection-lite), Phase 4 platform work (`docs/design/PHASE4_PLATFORM_PLAN.md`), and external integrations (`docs/design/INTEGRATIONS_PLAN.md`), which remain intentionally split into later issue groups.
