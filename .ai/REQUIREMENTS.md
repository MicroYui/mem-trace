...
- Recommended target after R1: OpenTelemetry/OpenInference exporter, unless real adoption feedback reprioritizes maintenance scheduler completion, admin workflow, or advanced retrieval/storage.
...
- R1-C2 Step 5 synced `docs/design/RELEASE_READINESS_PLAN.md`, `docs/design/ROADMAP.md`, and `.ai` memory to mark R1 complete and identify OpenTelemetry/OpenInference exporter as the recommended next feature slice.
