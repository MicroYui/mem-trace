...
**Current selected coding plan:** I7 compaction-negative retained facts is complete through I7.6 after completing `docs/design/PROVIDER_REGISTRY_KEY_ONTOLOGY_PLAN.md` for ROADMAP §10 Provider Registry + §11 Controlled Memory Key Ontology through P10. Next coding-plan selection should be made from post-I7 candidates: real Reflection/Forgetting scheduler, Phase 4 async/lifecycle/governance (`docs/design/PHASE4_PLATFORM_PLAN.md`), or TS/MCP/IDE integrations (`docs/design/INTEGRATIONS_PLAN.md`).
