...
- Git commits: do NOT append a `Co-Authored-By: Claude ...` trailer (or any AI co-author trailer) to commit messages. Commits are authored by the git user (MicroYui) only. (User preference, 2026-06-30.)
